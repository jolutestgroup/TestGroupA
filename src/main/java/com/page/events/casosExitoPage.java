...
public class casosExitoPage extends Base {
	...
	By messageLocator = By.cssSelector("#post-1468 > div > div > div > div.et_pb_section.et_pb_section_0.et_pb_with_background.et_section_regular > div.et_pb_row.et_pb_row_1 > div > div > div > div.et_pb_tab.et_pb_tab_0.clearfix.et_pb_active_content.et-pb-active-slide > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > strong");
	...
	public void casosPage() throws InterruptedException {
		...
		if (isDisplayed(estrategiaLocator)) {
			System.out.println("La pagina Casos de Exito esta funcionando correctamente");
			
		}else {
			
			System.out.println("Hubo un problema con la pagina Casos de Exito");
