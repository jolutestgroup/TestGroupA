...
public class nosotrosPage extends Base{
	...
	By messageLocator = By.cssSelector("#post-1195 > div > div > div > div.et_pb_section.et_pb_section_1.et_section_regular > div > div.et_pb_column.et_pb_column_1_2.et_pb_column_1.et_pb_css_mix_blend_mode_passthrough > div > div > p:nth-child(1) > span > strong");
	...
	public void nosotrosGroup() throws InterruptedException {
		...
		if (isDisplayed(nosotros2Locator)) {	
			System.out.println("La pagina nosotros esta funcionando correctamente");
			
		}else {
			System.out.println("Hubo un problema con la pagina Nosotros");
