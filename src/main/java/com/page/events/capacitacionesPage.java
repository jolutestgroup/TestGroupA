...
public class capacitacionesPage extends Base {
	...
	public void CapacitacionesPage() throws InterruptedException {
		...
		if (isDisplayed(capacitacionesLocator)) {
			System.out.println("La pagina Capacitaciones esta funcionando correctamente");
			
		}else {
		
			System.out.println("Hubo un error en la solicitud de la pagina Capacitaciones");
